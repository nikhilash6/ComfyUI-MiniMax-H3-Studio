...
function installStyles() {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    .h3pm{margin:12px 0 6px;padding:8px 10px;border:1px solid rgba(45,212,191,.18);border-radius:8px;background:rgba(0,0,0,.22);color:#e7f4f3;font-size:10px}.h3pm *{box-sizing:border-box}
    .h3pm-head{display:flex;justify-content:space-between;gap:8px;align-items:flex-start}.h3pm-title{font-size:9.5px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#99f6e4}.h3pm-sub{font-size:8px;opacity:.55;margin-top:1px;max-width:560px;line-height:1.35}.h3pm-state{font-size:8px;white-space:nowrap;padding:2px 5px;border:1px solid rgba(255,255,255,.1);border-radius:999px;opacity:.7}
    .h3pm-profiles{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:5px;margin-top:6px}.h3pm-profile{padding:6px 7px;border:1px solid rgba(255,255,255,.07);border-radius:6px;background:rgba(0,0,0,.15);min-width:0}.h3pm-profile.recommended{border-color:rgba(45,212,191,.28);background:rgba(45,212,191,.025)}.h3pm-badge{display:inline-block;font-size:7px;font-weight:800;letter-spacing:.06em;padding:1px 4px;border:1px solid rgba(45,212,191,.28);border-radius:999px;color:#99f6e4}.h3pm-profile-title{font-size:9px;font-weight:750;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.h3pm-profile-text{font-size:7.8px;opacity:.55;line-height:1.3;min-height:22px;margin-top:2px}.h3pm-files{margin-top:4px;font-size:7.5px;opacity:.65;line-height:1.35}.h3pm-actions{display:flex;gap:4px;flex-wrap:wrap;margin-top:5px}.h3pm-btn{border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:inherit;border-radius:4px;padding:3px 6px;cursor:pointer;font:inherit;font-size:8px;font-weight:600}.h3pm-btn.primary{border-color:rgba(45,212,191,.38);background:rgba(45,212,191,.1)}.h3pm-btn:disabled{opacity:.35;cursor:not-allowed}
    .h3pm-models{margin-top:6px;border-top:1px solid rgba(255,255,255,.06);padding-top:5px}.h3pm-model-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:6px;padding:3px 2px;border-top:1px solid rgba(255,255,255,.04)}.h3pm-model-name{font-weight:650;font-size:8.5px}.h3pm-model-meta{font-size:7.5px;opacity:.48;margin-top:1px;overflow-wrap:anywhere}.h3pm-model-status{font-size:8px;white-space:nowrap;align-self:center}.h3pm-model-status.ok{color:#86efac}.h3pm-model-status.bad{color:#fca5a5}.h3pm-legacy{margin-top:5px;padding:5px 6px;border:1px dashed rgba(255,255,255,.08);border-radius:6px;font-size:7.8px;opacity:.65}.h3pm-log{margin-top:5px;font-size:8px;opacity:.6}.h3pm-legacy-base-row{display:none!important}
