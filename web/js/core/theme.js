...
export function installTheme() {
  ...
  style.textContent = `
    .h3s-studio-panel {
      ...
      --h3s-accent: #34d3b5;
      --h3s-warning: #e6ad55;
      display: flex; flex-direction: column; gap: 7px; width: 100%; height: 100%; max-height: 100%; min-height: 0;
      box-sizing: border-box; padding: 9px 10px 14px; overflow-y: scroll !important; overflow-x: hidden !important; overscroll-behavior: contain;
      scrollbar-width: thin; scrollbar-color: #58646d transparent;
    ...
    .h3s-studio-panel::-webkit-scrollbar { width: 8px !important; display: block !important; }
    .h3s-studio-panel::-webkit-scrollbar-track { background: rgba(0, 0, 0, 0.2) !important; border-radius: 4px; }
    .h3s-studio-panel::-webkit-scrollbar-thumb { background: #58646d !important; border-radius: 4px; }
    .h3s-studio-panel::-webkit-scrollbar-thumb:hover { background: #8896a1 !important; }
    .h3s-studio-panel *, .h3s-studio-panel *::before, .h3s-studio-panel *::after { box-sizing: border-box; }
    .h3s-workspace { display: grid; grid-template-columns: minmax(0, 1.15fr) minmax(0, 1fr); gap: 8px; align-items: start; width: 100%; min-width: 0; min-height: 0; }
    .h3s-col {
      display: flex;
    ...
    .h3s-col::-webkit-scrollbar-thumb { background: #58646d !important; border-radius: 4px; }
    .h3s-col::-webkit-scrollbar-thumb:hover { background: #8896a1 !important; }
