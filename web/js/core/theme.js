...
export function installTheme() {
  ...
  style.textContent = `
    .h3s-studio-panel {
      ...
      box-sizing: border-box; padding: 9px 10px 14px; overflow-y: auto !important; overflow-x: hidden !important; overscroll-behavior: contain;
      scrollbar-width: thin; scrollbar-color: var(--h3s-border) transparent;
    ...
    .h3s-studio-panel::-webkit-scrollbar { width: 6px; }
    .h3s-studio-panel::-webkit-scrollbar-track { background: transparent; }
    ...
    .h3s-workspace { display: grid; grid-template-columns: minmax(0, 1.15fr) minmax(0, 1fr); gap: 8px; align-items: start; width: 100%; min-width: 0; }
